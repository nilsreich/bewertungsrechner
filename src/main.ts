...
/**
 * Debounced version of saveState to prevent excessive localStorage writes during high-frequency events (e.g. typing).
 * Improves performance by reducing main thread blocking time.
 */

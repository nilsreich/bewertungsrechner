...
/**
 * Debounced version of saveState for high-frequency input events.
 * Delays the save operation by 1000ms.
 */
...
examTitleInput?.addEventListener('input', saveStateDebounced);
